...
> 安裝此skill前請先部屬好您的Claude code


## 1. 首次安裝步驟

**將此頁 URL 貼給 Claude Code 說「幫我安裝這個 skill」**。Claude 會自動依照下面進階區的步驟跑完整套，過程中只會跟你確認 1-2 次（重啟 Claude Code 那一步）。
...
在 Claude Code 說「做SV名片、幫我做名片、做名片...」，並將簽呈 PDF 拖進對話框

Claude 會自動：
1. 從簽呈 PDF 萃取你的個人資料
2. 開 Illustrator 套模板、替換姓名/職稱/電話/Email
3. 生成 QR Code 並貼到名片上
4. 停下來問你「**請確認資訊無誤**」← ‼️這是流程中唯一需要你動手的點‼️
